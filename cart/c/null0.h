...
typedef enum FileType {
  FILETYPE_REGULAR = 0,   // a normal file
  FILETYPE_DIRECTORY = 1, // a directory
  FILETYPE_SYMLINK = 2,   // a symlink
  FILETYPE_OTHER = 3      // something completely different like a device
} FileType;
